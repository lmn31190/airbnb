          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="absolute bottom-2 right-2 bg-black bg-opacity-50 rounded-xl py-2 px-3 cursor-pointer text-white"
              >
                <svg
              ...
              <button
                ...
                className="absolute bottom-2 left-2 bg-black bg-opacity-50 rounded-xl py-2 px-3 cursor-pointer text-white"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
