  ...
  return (
    <div>
      <nav className="w-full flex justify-center gap-2 mt-8 mt-4 mb-8">
        <Link className = {linkClasses("profil")} flex gap-2 to={"/account"}>
          <svg
        ...
        <Link
          className={linkClasses("bookings")} flex gap-2
          to={"/account/bookings"}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link className={linkClasses("places")} flex gap-2 to={"/account/places"}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
